...
public class SimuladorBancarioTest
{
    ...
    public void testpunto1() {
    	...
    	cuenta.avanzarMesSimulacion();
    	cuenta.cerrarCDT();
    	//assertTrue("ERROR EN EL PUNTO 1",cuenta.calcularSaldoTotal()==1902800);}
    	assertEquals("ERROR EN EL PUNTO 1",1902800,cuenta.calcularSaldoTotal(),0);}
		catch (Exception e) {
    ...
    {   
    	...
    	assertEquals( "El saldo de la cuenta corriente no es el esperado", 98568988, ( int )cuenta.calcularSaldoTotal(), 20 );
